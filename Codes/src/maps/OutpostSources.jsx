...
import { getGenericMapOutpost,setMapControls } from '../services/genericMapServiceOutpost';
...
function WaterSources() {
    ...
    useEffect(() => {
        const map = getGenericMapOutpost(mapRef,timeFrame,latitude,longitude);
    ...
    return (
        <div className="relative w-full h-screen">
            ...
            {/* Koordinat Arama Paneli */}{/* Koordinat Arama Paneli */}
